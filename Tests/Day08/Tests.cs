...
gcafb gcf dcaebfg ecagb gf abcdeg gaef cafbge fdbac fegbdc | fgae cfgab fg bagce";
            ...
            var entries = input.Split(Environment.NewLine).Select(sl => new Entry(sl));

            // Act
            var result = entries.Sum(e => e.GetEasyDigitsAppearCount());
...
gcafb gcf dcaebfg ecagb gf abcdeg gaef cafbge fdbac fegbdc | fgae cfgab fg bagce";
            ...
            // Act
            var result = entries.Sum(e => e.GetOutputValue());
