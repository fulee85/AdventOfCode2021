...
22 11 13  6  5
 2  0 12  3  7";
            ...
            var bingoGame = new BingoGame(input.Split(Environment.NewLine));

            // Act
            var result = bingoGame.GetFirstWinningTableResult();
...
22 11 13  6  5
 2  0 12  3  7";
            ...
            // Act
            var result = bingoGame.GetLastWinningTableResult();
